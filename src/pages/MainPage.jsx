                        ...
                        <div className={"flex flex-col gap-6 sm:gap-8"}>
                            ...
                            <div className={"flex flex-col gap-4"}>
                                ...
                                <div className={"flex items-center gap-4 sm:gap-6"}>
                                    {[1,2,3,4,5].map((item) => (
                                        <button type={"button"} onClick={() => handleSelectedRating(item)} className={`flex justify-center items-center bg-grey-900 rounded-3xl w-10.5 h-10.5 sm:w-13 sm:h-13 group hover:bg-white ${(selectedRating === item) ? "bg-orange-500" : ""}`}>
                            ...
                            <button type={"submit"} onClick={handleSubmit} disabled={selectedRating === 0} aria-describedby={"disable-submit-select-rating"} className={`text-center bg-orange-500 uppercase text-grey-950 py-4 sm:py-1.5 text-preset-5 font-preset-5-bold sm:font-preset-5-semibold leading-preset-5-semibold sm:leading-preset-5-semibold tracking-preset-5-semibold sm:tracking-preset-5-semibold rounded-3xl hover:bg-white ${selectedRating === 0 ? "cursor-not-allowed" : "cursor-pointer"}`}>submit</button>
                        </div>
